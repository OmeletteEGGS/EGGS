...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("EGGS");
    case mBTC: return QString("mEGGS");
    case uBTC: return QString::fromUtf8("μEGGS");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("EGGS");
    case mBTC: return QString("Milli-EGGS (1 / 1,000)");
    case uBTC: return QString("Micro-EGGS (1 / 1,000,000)");
    default: return QString("???");
    }
}
