...
{
    resize(850, 550);
    setWindowTitle(tr("EGGS Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/EGGS_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a EGGS address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);
	
    onthewebAction = new QAction(QIcon(":/icons/web"), tr("&eggdrop.pw"), this);
    onthewebAction->setToolTip(tr("Visit links related to EGGS"));
    ...
    aboutAction = new QAction(QIcon(":/icons/EGGS_tooltip"), tr("&About EGGS"), this);
    aboutAction->setToolTip(tr("Show information about EGGS"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for EGGS"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/EGGS_tooltip"), tr("Show/Hide &EGGS"), this);
    toggleHideAction->setToolTip(tr("Show or hide the EGGS window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/EGGS_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/EGGS_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/EGGS_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("EGGS client"));
    trayIcon->setIcon(QIcon(":/icons/EGGS_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EGGS network", "", count));
}
