        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start EGGS on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start EGGS after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the EGGS client port on the router. This only works when your router supports UPnP and it is enabled."));
    ...
    QLabel *fee_help = new QLabel(tr("EGGS has no network transaction fees. This means you can send and combine coins as much and as often as you want for FOR FREE. Play with it, experiment, and set your blocks up perfectly to maximize your stake returns"));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show EGGS addresses in the transaction list"));
