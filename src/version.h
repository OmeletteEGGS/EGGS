...
// Copyright (c) 2012-2013 The EGGS developers
...
// EGGS version - intended for display purpose only
#define EGGS_VERSION_MAJOR       1
#define EGGS_VERSION_MINOR       0
#define EGGS_VERSION_REVISION    0
#define EGGS_VERSION_BUILD       0

static const int EGGS_VERSION =
                           1000000 * EGGS_VERSION_MAJOR
                         +   10000 * EGGS_VERSION_MINOR
                         +     100 * EGGS_VERSION_REVISION
                         +       1 * EGGS_VERSION_BUILD;

// EGGS version - reference for code tracking
