EGGS 0.1.2
Copyright (c) 2014 EGGS developers
...
About EGGS
---------------
EGGS is a EGGS network-compatible, community-developed wallet client.

The project has been designed to provide people with a
stable, secure, and feature-rich alternative to the EGGS reference
wallet (http://github.com/EGGS/EGGS). 

To help faciliate broad community cooperation, a number of trusted 
EGGS/Peershares community leaders have write permissions to the project's 
...
Resources
---------
EGGS source code: https://github.com/EGGS/EGGS

For the most current instructions covering how to compile EGGS from 
source on a variety of operating systems, please visit:
https://github.com/EGGS/EGGS/tree/master/doc

Open software issues can be viewed, and new issues can be reported at:
https://github.com/EGGS/EGGS/issues?state=open

EGGS discussion forums (hosted by EGGSTalk.org): 
http://www.EGGStalk.org/index.php?board=64.0



Acknowledgements
----------------
EGGS owes it's existance to the time and effort put forth by
the developers and supporters of the following projects:


	EGGS (EGGS) 0.4.0 BETA
	Copyright (c) 2011-2014 Bitcoin Developers

	Distributed under the MIT/X11 software license
	(http://www.opensource.org/licenses/mit-license.php)

	EGGS is a free open source project with the goal of providing a 
